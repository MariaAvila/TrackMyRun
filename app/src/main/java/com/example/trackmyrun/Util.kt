 ...
 */
fun formatRuns(nights: List<MyRun>, resources: Resources): Spanned {
    ...
    sb.apply {
        ...
        nights.forEach {
            ...
            if (it.endTimeMilli != it.startTimeMilli) {
                ...
                append(resources.getString(R.string.distance_travelled))
                append("\t${it.distanceTravelled.toString()}<br>")
